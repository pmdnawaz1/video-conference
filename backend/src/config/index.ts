...
const config: Config = {
  ...
  database: {
    url: process.env.DATABASE_URL || 'postgresql://localhost:5432/video_conference',
    ...
    maxIdleConnections: parseInt(process.env.DB_MAX_IDLE_CONNECTIONS || '10', 10),
    maxLifetimeMinutes: parseInt(process.env.DB_MAX_LIFETIME_MINUTES || '60', 10),
  },
  jwt: {
