...
function generateIcon(size) {
  ...
  ctx.beginPath();
  ctx.arc(centerX + bodyWidth * 0.2, centerY - bodyHeight * 0.15, iconSize * 0.08, 0, 2 * Math.PI);
  ctx.fill();
...
appleCtx.beginPath();
appleCtx.arc(appleCenterX - appleBodyWidth * 0.15, appleCenterY, appleIconSize * 0.18, 0, 2 * Math.PI);
appleCtx.fill();

appleCtx.fillStyle = '#3b82f6';
appleCtx.beginPath();
appleCtx.arc(appleCenterX - appleBodyWidth * 0.15, appleCenterY, appleIconSize * 0.1, 0, 2 * Math.PI);
appleCtx.fill();

appleCtx.fillStyle = '#ef4444';
appleCtx.beginPath();
appleCtx.arc(appleCenterX + appleBodyWidth * 0.2, appleCenterY - appleBodyHeight * 0.15, appleIconSize * 0.08, 0, 2 * Math.PI);
appleCtx.fill();
