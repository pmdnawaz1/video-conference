...
function VideoDebugApp() {
  ...
  return (
    <div className="min-h-screen bg-muted0 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="bg-muted0 rounded-lg overflow-hidden">
              <video
                ref={videoRef}
                autoPlay
                playsInline
                muted
                controls
                className="w-full h-64 object-cover bg-muted0"
        ...
        <Card>
          ...
          <CardContent>
            <div className="bg-muted0 text-green-400 p-4 rounded-lg font-mono text-sm h-64 overflow-y-auto">
              {logs.map((log, i) => (
                <div key={i}>{log}</div>
              ))}
            </div>
