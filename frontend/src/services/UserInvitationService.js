...
class UserInvitationService {
  ...
  async createBulkUserInvitations(invitationsData) {
    try {
      const response = await fetch(
        `${this.apiBaseUrl}/admin/users/invite/bulk`,
        {
          method: "POST",
          headers: this.getAuthHeaders(),
          body: JSON.stringify({
      ...
      console.error(
        "UserInvitationService: Error creating bulk invitations:",
        error,
      );
      return {
        success: false,
  ...
  async getAllUserInvitations(filters = {}) {
    try {
      ...
      const response = await fetch(
        `${this.apiBaseUrl}/admin/users/invitations?${queryParams}`,
        {
          headers: this.getAuthHeaders(),
        },
      );
      ...
      console.error(
        "UserInvitationService: Error fetching invitations:",
        error,
      );
      return {
        success: false,
  ...
  async resendUserInvitation(invitationId, customMessage = null) {
    try {
      const response = await fetch(
        `${this.apiBaseUrl}/admin/users/invitations/${invitationId}/resend`,
        {
          method: "PUT",
          headers: this.getAuthHeaders(),
          body: JSON.stringify({
      ...
      console.error(
        "UserInvitationService: Error resending invitation:",
        error,
      );
      return {
        success: false,
  ...
  async cancelUserInvitation(invitationId, reason = null) {
    try {
      const response = await fetch(
        `${this.apiBaseUrl}/admin/users/invitations/${invitationId}/cancel`,
        {
          method: "PUT",
          headers: this.getAuthHeaders(),
          body: JSON.stringify({
      ...
      console.error(
        "UserInvitationService: Error cancelling invitation:",
        error,
      );
      return {
        success: false,
  ...
  async validateUserInvitationToken(token) {
    try {
      const response = await fetch(
        `${this.apiBaseUrl}/public/user-invitation/${token}/validate`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  async completeUserRegistration(token, registrationData) {
    try {
      ...
      const response = await fetch(
        `${this.apiBaseUrl}/public/user-invitation/${token}/complete`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          ...
          body: JSON.stringify({
            ...
            notifications_enabled:
              registrationData.notificationsEnabled !== false,
            ...
            preferences: {
              ...
              timezone:
                ...
                Intl.DateTimeFormat().resolvedOptions().timeZone,
              email_notifications:
                registrationData.emailNotifications !== false,
              browser_notifications:
                registrationData.browserNotifications !== false,
      ...
      console.error(
        "UserInvitationService: Error completing registration:",
        error,
      );
      return {
        success: false,
  ...
  async getInvitationStats(organizationId = null, timeRange = "30d") {
    try {
      ...
      const response = await fetch(
        `${this.apiBaseUrl}/admin/users/invitations/stats?${queryParams}`,
        {
          headers: this.getAuthHeaders(),
        },
      );
  ...
  async getEmailTemplates() {
    try {
      const response = await fetch(
        `${this.apiBaseUrl}/admin/email-templates/user-invitation`,
        {
          headers: this.getAuthHeaders(),
        },
      );
  ...
  async updateEmailTemplate(templateId, templateData) {
    try {
      const response = await fetch(
        `${this.apiBaseUrl}/admin/email-templates/${templateId}`,
        {
          method: "PUT",
          headers: this.getAuthHeaders(),
