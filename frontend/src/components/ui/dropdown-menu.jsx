  ...
  ({ className, inset, children, ...props }, ref) => (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "text-primary hover:bg-muted focus:bg-muted data-[state=open]:bg-muted",
        inset && "pl-8",
        className,
      )}
      {...props}
  ...
  ({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "text-primary hover:bg-muted focus:bg-muted",
...
const DropdownMenuShortcut = ({ className, ...props }) => {
  return (
    <span
      className={cn("ml-auto text-xs tracking-widest opacity-60 text-muted", className)}
      {...props}
    />
  );
};
