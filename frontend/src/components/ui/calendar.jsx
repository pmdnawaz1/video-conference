...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
  return (
    <DayPicker
      ...
      className={cn("p-3 text-primary", className)}
      classNames={{
        ...
        nav_button: cn(
          "btn-outline h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100"
        ),
        ...
        day: cn(
          "btn-ghost h-9 w-9 p-0 font-normal aria-selected:opacity-100"
        ),
        day_range_end: "day-range-end",
        day_selected: "bg-button-primary text-on-dark hover:bg-button-primary/90 hover:text-on-dark focus:bg-button-primary focus:text-on-dark",
        day_today: "bg-muted text-primary",
        day_outside: "day-outside text-muted opacity-50 aria-selected:bg-muted/50 aria-selected:text-muted aria-selected:opacity-30",
