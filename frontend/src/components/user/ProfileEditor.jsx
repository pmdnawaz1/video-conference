...
import { 
  FiUser, FiMail, FiPhone, FiMapPin, FiBuilding, FiGlobe, 
  FiCamera, FiUpload, FiSave, FiX, FiEdit3, FiCheck,
  FiCalendar, FiBriefcase, FiLinkedin, FiGithub, FiTwitter, FiInstagram
} from 'react-icons/fi';
...
const ProfileEditor = ({ onClose }) => {
  ...
  const { profile, updateProfile, isProfileUpdating, profileError } = useUserStore();
  ...
  const handleSubmit = async (e) => {
    ...
    const profileData = {
      ...
      avatar: formData.avatar !== (profile?.avatar || user?.avatar) ? formData.avatar : undefined
    };
