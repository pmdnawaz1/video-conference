...
import { Loader2, CheckCircle, XCircle, Clock, Building, User, Mail, Shield, AlertCircle, Eye, EyeOff, Sparkles } from 'lucide-react';
...
const UserInvitationLanding = () => {
  ...
  const validateInvitation = async () => {
    ...
    try {
      const result = await userInvitationService.validateUserInvitationToken(token);
  ...
  const checkPasswordStrength = (password) => {
    ...
    if (!validation.isValid) {
      ...
      if (score <= 2) feedback.push('Consider adding more variety to make it stronger');
  ...
  const validateForm = () => {
    ...
    const passwordValidation = userInvitationService.validatePassword(formData.password);
  ...
  const handleRegistration = async () => {
    ...
    try {
      const result = await userInvitationService.completeUserRegistration(token, formData);
            ...
            <div className="space-y-4">
              <div className="bg-red-50 border border-red-200 rounded-md p-3">
                <p className="text-sm text-red-700">
                  This invitation may have expired or been cancelled. Please contact your administrator for a new invitation.
                </p>
              </div>
              <Button 
                variant="outline" 
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    You've been invited by {admin?.first_name} {admin?.last_name}
                  </CardDescription>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleFormChange('browserNotifications', checked)}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleFormChange('meetingReminders', checked)}
                      />
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => handleFormChange('privacyAccepted', checked)}
                      className={errors.privacyAccepted ? 'border-red-500' : ''}
                    />
                    <Label htmlFor="privacyAccepted" className="text-sm leading-relaxed">
                      I agree to the <a href="/privacy" target="_blank" className="text-blue-600 hover:underline">Privacy Policy</a> *
                    </Label>
                  </div>
                  ...
                  <div className="flex items-start space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => handleFormChange('marketingConsent', checked)}
                    />
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100">
        <Card className="w-full max-w-md border-green-200 shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-green-700 text-xl">Welcome Aboard!</CardTitle>
          ...
          <CardContent className="text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-green-600">Setting up your workspace...</p>
            </div>
