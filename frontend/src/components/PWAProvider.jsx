...
const UpdatePrompt = ({ onUpdate, onDismiss }) => (
  <div className="fixed inset-x-0 bottom-0 z-50 p-4">
    <div className="mx-auto max-w-sm bg-primary text-primary-foreground rounded-lg shadow-lg p-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2 ml-4">
          ...
          <button
            onClick={onDismiss}
            className="bg-secondary text-secondary-foreground px-3 py-1 rounded text-sm font-medium hover:bg-secondary/80 transition-colors"
          >
            Later
          </button>
        </div>
