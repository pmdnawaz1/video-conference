...
const PWATest = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 p-4 bg-gray-800 text-white rounded-lg shadow-lg text-xs max-w-xs z-50">
      ...
      <div className="space-y-1">
        ...
        <div className="flex justify-between">
          ...
          <span className={updateReady ? 'text-green-400' : 'text-gray-400'}>
            {updateReady ? '✅' : '⏳'}
          </span>
        </div>
        <div className="flex justify-between">
